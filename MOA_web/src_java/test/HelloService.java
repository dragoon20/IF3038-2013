...
public class HelloService extends Service {
    ...
    public final static QName SERVICE = new QName("http://test.com/", "HelloService");
    public final static QName HelloPort = new QName("http://test.com/", "HelloPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/media/Data/workspace/MOA_services/WebContent/wsdl/hello.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/media/Data/workspace/MOA_services/WebContent/wsdl/hello.wsdl");
        }
        WSDL_LOCATION = url;
    }
